...
public class TestPlayer {
    ...
    public void testTakeDamage(){
        Player playerDefending = new Player(null, null);
        Player playerAttacking = new Player(null, null);
        Player playerAttackingB = new Player(null, null);
    ...
    */
    ...
    public void testResolveDeathNormalModeShouldSucceed(){
        Player deadPlayer = new Player(null, null);
        Player attacker1 = new Player(null, null);
        Player attacker2 = new Player(null, null);
